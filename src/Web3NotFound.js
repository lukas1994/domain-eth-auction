    ...
    return (
      <div className="Web3Notice">
        ...
        <div className="answer">
          To get started, you need to connect your browser to the blockchain. An
          extension called MetaMask lets you do this: <br />
          ...
          <br />You may need to refresh this page once you've installed
          MetaMask.
        </div>
      </div>
    );
